...
def test_project_specific_maturity_modules_import():
    import agent_trace_viewer.trace_store as _trace_store
    import agent_trace_viewer.dashboard_metrics as _dashboard_metrics
    import agent_trace_viewer.filter_benchmark as _filter_benchmark
